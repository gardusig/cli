"""Confirmation gates — prefer cli.internal.write.gate for new code."""

from __future__ import annotations

from gardusig_cli.internal.write.gate import confirm_prompt, require_write_gate, write_gate
