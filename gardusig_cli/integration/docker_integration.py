"""Integration checks for cli docker CLI commands."""
...
from gardusig_cli.integration.docker_mocks import patch_docker_cli
from gardusig_cli.services import docker_runtime as runtime_mod
...
def docker_checks() -> list[DockerCheck]:
    ...
    return [
        ...
        DockerCheck("docker ps", ("docker", "ps"), needle="cli-mock-running"),
        DockerCheck(
            "docker ps no docker",
            ("docker", "ps"),
            kind="refuse",
        ...
        DockerCheck("docker stats", ("docker", "stats", "--by", "cpu"), needle="cli-mock-running"),
        DockerCheck(
        ...
        DockerCheck("docker containers", ("docker", "containers"), needle="cli-mock-stopped"),
        DockerCheck(
        ...
        DockerCheck("docker images", ("docker", "images"), needle="cli/mock"),
        DockerCheck(
...
_LIVE_CONTAINER = "cli-integration-live"


def run_live_docker_checks(repo_root: Path) -> list[str]:
    """Exercise cli docker against the host daemon (ubuntu CI / local with Docker)."""
    errors: list[str] = []
