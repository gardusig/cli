...
from gardusig_cli.integration.contest_integration import CONTEST_SUBCOMMANDS, ContestCheck, contest_checks
...
def assert_integration_coverage_gate() -> None:
    ...
    from gardusig_cli.integration.public_commands import assert_public_command_registry_complete
