...
from gardusig_cli.utils.quick_defaults import (
...
def test_suggest_branch_name_starts_at_one() -> None:
    with patch("gardusig_cli.utils.quick_defaults.datetime") as mock_dt:
...
def test_default_tag_name_is_iso_date() -> None:
    with patch("gardusig_cli.utils.quick_defaults.date") as mock_date:
