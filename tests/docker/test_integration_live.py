...
from src.integration.docker_integration import run_live_docker_checks
...
def test_live_docker_checks_success(mock_run: MagicMock) -> None:
    ...
    with patch("src.integration.docker_integration.run_docker_check") as mock_check:
...
def test_live_docker_delete_reports_still_present(mock_run: MagicMock) -> None:
    ...
    from src.integration.docker_integration import _LIVE_CONTAINER

    with patch(
        "src.integration.docker_integration.run_docker_check",
