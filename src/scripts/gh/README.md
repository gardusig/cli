...
./src/scripts/git/reset.sh --yes --main-only
./src/scripts/git/start.sh issue-42-slug --yes
# … work …
./src/scripts/git/push.sh --yes
./src/scripts/git/review.sh
./src/scripts/gh/pr-create.sh --title "." --body "" --yes
# merge in GitHub UI — pr-merge.sh is blocked by policy
./src/scripts/gh/issue-close.sh 42 --comment "Done" --yes
