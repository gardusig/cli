...
from src.utils.config import project_root, tags_dir_path


def in_docker_integration() -> bool:
    """True when running under CLI-managed unit or integration test gates."""
...
def require_docker_integration(*, context: str = "integration") -> None:
    ...
    raise RuntimeError(
        ...
        "Use cli test python unit . or cli test python integration ."
    )
